<%@ Page Title="" Language="C#" MasterPageFile="~/baitap/MasterPage.master" AutoEventWireup="true" CodeFile="1PagePiano.aspx.cs" Inherits="baitap_1PagePiano" %>
            ...
            <br />
             <table class="bangTimTour">
                ...
                <tr>
                 ...
                 <tr>
                     <td>
                         <asp:HyperLink ID="HyperLink1" CssClass="btn btn-success" Font-Underline="false" runat="server" NavigateUrl='<%# "1ChiTietSP.aspx?ID=" + Eval("MaDan") %>'>Chi Tiết</asp:HyperLink>
                     <td>
                 </tr>
              </table>
        </ItemTemplate>
