<%@ Page Title="" Language="C#" MasterPageFile="~/baitap/MasterPage.master" AutoEventWireup="true" CodeFile="TrangChu.aspx.cs" Inherits="baitap_TrangChu" %>
    ...
    <section class="Product-section" id="Product">
        ...
        <div class="row">
            <div class="col span-1-of-4 Product-picture">
                ...
                <p>
                    <a class="picture-title" href="PagePiano.aspx">Piano</a>
                </p>
            </div>
            ...
            <div class="col span-1-of-4 Product-picture">
                ...
                <p >
                    <a class="picture-title" href="Default.aspx">Organ</a>
            ...
            <div class="col span-1-of-4 Product-picture">
                ...
                <p >
                    <a class="picture-title" href="PageGhita.aspx">Guitar</a>
                </p>
            </div>
            ...
            <div class="col span-1-of-4 Product-picture">
                ...
                <p >
                    <a class="picture-title" href="PageDrum.aspx"> Drum</a>
