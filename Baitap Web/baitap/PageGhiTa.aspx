<%@ Page Title="" Language="C#" MasterPageFile="~/baitap/MasterPage.master" AutoEventWireup="true" CodeFile="PageGhiTa.aspx.cs" Inherits="baitap_PageGhiTa" %>
        ...
        <ItemTemplate>
             <table class="bangTimTour">
                ...
                <tr>
                 ...
                 <tr>
                     <td>
                         <asp:HyperLink ID="HyperLink1" CssClass="btn btn-success" Font-Underline="false" runat="server" NavigateUrl='<%# "ChiTietSP.aspx?ID=" + Eval("MaDan") %>'>Chi Tiet</asp:HyperLink>
                         <asp:HyperLink ID="HyperLink2" CssClass="btn btn-success" runat="server">Mua</asp:HyperLink>
                     <td>
                 </tr>
              </table>
        </ItemTemplate>
